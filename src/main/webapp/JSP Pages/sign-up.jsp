<%-- 
    Document   : sign-up
    Created on : Dec 5, 2024, 8:42:35 PM
    Author     : Niki
--%>
...
<html>
    ...
    <body>
        <div class="wrapper">
            ...
            <div><a id="sign-up-link" href="sign-in.jsp">Already signed up? Click here to sign in!</a></div>
        </div>
        <div class="footer">All rights reserved © 2025</div>
        <script src="${pageContext.request.contextPath}/Scripts/validation-script.js"></script>
        <script src="${pageContext.request.contextPath}/Scripts/params-script.js"></script>
    </body>
</html>